...
<TopAppBar variant="static" >
    <Row>
        ...
        <Section align="end" toolbar>
            <div>
                {#if user}
                    <Button on:click={() => handleSignOut()} variant="raised" color="secondary" class="button-shaped-round"><Label>Sign out</Label></Button>
                {:else}
                    <Button on:click={() => handleGoogleLogin()} variant="raised" color="secondary" class="button-shaped-round"><Label>Sign in</Label></Button>
                {/if}
            </div>
        </Section>
    </Row>
